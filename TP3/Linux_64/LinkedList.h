...
int ll_clear(LinkedList* this); //vuelve la lista a su estado original // como cuando hicimos el new, elimina todos los nodos existentes
...
LinkedList* ll_clone(LinkedList* this);// deep copy, no es crear otro puntero a lista y le asigno la lista orignal, eso hace que ambas listas apunten al mismo lugar, deep copy crea una lista nueva con elementos exactamente iguales a la lista anterior, y estos apuntan a otra direccion, el elemento se encuentra en el mismo lugar(ej una persona llamada juan) pero apunta a dos lugares diferentes en memoria, utilizamos un bucle de adds en la lsta nueva
